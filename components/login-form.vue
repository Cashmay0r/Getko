<template>
  <div
    class="bg-white w-full flex flex-col rounded-xl overflow-hidden shadow-xl"
  >
    <div class="my-2 w-full h-full flex flex-col items-center">
      ...
      <form class="my-4" @submit.prevent="submitLogin">
        ...
        <div
          class="flex flex-row justify-evenly w-full h-full items-center mb-4"
        >
          <div class="text-sm">
      ...
      <p class="text-sm">
        Not registered yet?
        <a
          class="hover:no-underline underline text-primary-green cursor-pointer"
